...
<style type="text/css">
body {background-image:url("image/f.jpg");background-size:100%;}
...
<body ><center>
<br><br><br><br><br>
<button class="button1"><i class="ex1"><a href="${pageContext.request.contextPath }/ManaHome" >返回主管理菜单</a></i></button>
<form action="${pageContext.request.contextPath }/findTicketsByIdent" method="post" >

<br><br>
用户身份证号:
<input type="text" name="ident_id" id="id"/><br>
<button class="button1"><i class="ex1">查询用户机票</i></button>
