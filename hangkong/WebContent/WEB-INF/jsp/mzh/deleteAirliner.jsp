...
<center>
<fieldset>
    <form action="${pageContext.request.contextPath}/delete_Airliner" method="post" >
           <br>
          客机编码：<br>
          <input name="plane_id" type="text" placeholder=""/>
          <br>
          <button class="button1"><i class="ex1">删除</i></button>
