...
<body>
<center><fieldset>
    <form action="${pageContext.request.contextPath}/selectAirlinerByFlight2" method="post" >
          <br>
          <label for="">航班号：</label>
          <input name="flight_id" type="text" placeholder=""/>
          
           <button class="button1"><i class="ex1">查询</i></button>
<button class="button1"><i class="ex1">取消</i></button><br>                        
    </form>   
    </div>
    <div class="a"> <a href="${pageContext.request.contextPath }/main">返回主页</a></div>
</fieldset></center>
</body>
</html>