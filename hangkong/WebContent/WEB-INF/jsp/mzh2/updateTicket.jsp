...
<form action="${pageContext.request.contextPath}/update_Ticket" method="post"><br>
订单号：
  <input name="order_id"  type="text"/><br>
  航班号：<input name="f_flightid" type="text"/><br>
  <button class="button1"><i class="ex1">修改</i></button>
</form>
</fieldset>
</center>
</body>
