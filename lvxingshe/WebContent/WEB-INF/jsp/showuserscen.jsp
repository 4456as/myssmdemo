<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.itheima.po.User,com.itheima.po.ScenicSpot,java.util.List"%>
...
<title>我去过的景点 </title>
  ...
  <body>  
	  <div class="containerDiv">
        ...
        <div class="navigationDiv"><h1>我去过的景点</h1></div>
        <div class="foucsDiv">
        	<div class="leftDiv">
        		<%-- <jsp:useBean id="user_group" class="com.itheima.po.User" scope="session"/> --%>
				<%
				User user_spot=(User)session.getAttribute("USER_SCENERY_SESSION");
				List<ScenicSpot> sslist=user_spot.getScenicspotlist();
				%>
				<script type="text/javascript">
					document.write("<table>");
					document.write("<tr>");
					document.write("<th>景点编号</th><th>景点名</th><th>景点信息</th>");
					document.write("</tr>");
				</script>
				<% for(ScenicSpot spot:sslist){
					Integer sceid=spot.getSceid();String scename=spot.getScename();
					String sceinfot=spot.getSceinfo();
				%>
				<script type="text/javascript">
					
					document.write("<tr>");
					document.write("<td>"+"<%=sceid%>"+"</td>");
					document.write("<td>"+"<%=scename%>"+"</td>");
					document.write("<td>"+"<%=sceinfot%>"+"</td>");
					document.write("</tr>");
				</script>
				<%} %>
				<script type="text/javascript">
