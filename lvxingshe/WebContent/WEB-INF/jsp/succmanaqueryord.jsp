<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.itheima.po.Order,java.util.List"%>
...
<title>Insert title here</title>
  ...
  <body>  
	  <div class="containerDiv">
        ...
        <div class="navigationDiv"><h1>所有用户订单信息</h1></div>
        <div class="foucsDiv">
        	<div class="leftDiv">
        		<%-- <jsp:useBean id="user_group" class="com.itheima.po.User" scope="session"/> --%>
				<%
				List<Order> orderlist=(List<Order>)session.getAttribute("LISTORDERS_SESSION");
				%>
				<script type="text/javascript">
					document.write("<table>");
					document.write("<tr>");
					document.write("<th>订单编号</th><th>旅游团编号</th><th>用户编号</th>");
					document.write("</tr>");
				</script>
...
<!--             <div class="content3">
       ...
       <!--  </div> -->
        <div class="clearBoth"></div>
        <div class="footerDiv">
        	<a href="${pageContext.request.contextPath }/tomanaorders.action"><p>返回</p></a>
        </div>
      </div>
  </body>
</html>